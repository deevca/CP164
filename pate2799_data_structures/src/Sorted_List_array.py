...
class Sorted_List:
    ...
    def count(self, key):
        ...
        if i < 0:
            more_keys = False
        while i < len(self._values) and more_keys == True:
    ...
    def intersection(self, source1, source2):
        ...
        i = 0
        while i < len(source1):
            if source1._values[i] in source2 and source1._values[i] not in self._values:
    ...
    def is_identical(self, target):
        ...
        if len(self._values) == len(target):
            while i < len(target) and identical == True:
    ...
    def remove_many(self, key):
        ...
        while more_keys == True:
            self._values.pop(i)
            if i > len(self._values) or self._values[i] != key:
                more_keys = False
        return
    ...
    def split_key(self, key):
        ...
        while len(self._values) > 0:
            if self._values[i] < key:
                target1._values.append(deepcopy(self._values.pop(i)))
            else:
                target2._values.append(deepcopy(self._values.pop(i)))
    ...
    def union(self, source1, source2):
        ...
        while i < len(source1):
            if i < len(source2):
                if source1._values[i] < source2._values[i]:
                    if source1._values[i] not in self._values:
                        self._values.append(deepcopy(source1._values[i]))
                    if source2._values[i] not in self._values:
                        self._values.append(deepcopy(source2._values[i]))
                elif source1._values[i] == source2._values[i]:
                    if source1._values[i] not in self._values:
                        self._values.append(deepcopy(source1._values[i]))
                elif source1._values[i] > source2._values[i]:
                    if source2._values[i] not in self._values:
