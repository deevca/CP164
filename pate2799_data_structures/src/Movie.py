...
class Movie:
    ...
    def genres_menu():
        ...
        while i < len(Movie.GENRES):
            string += '/n' + ('{:>2} {}'.format(i, str(Movie.GENRES[i])))
            i += 1
    ...
    def genres_string(self):
        ...
        if self.genres != None:
            ...
            while i < len(genres_list):
                if len(genres_list) - i == 1:
                    string += str(self.GENRES[genres_list[i]])
                elif len(genres_list) - i > 1:
                    string += str(self.GENRES[genres_list[i]]) + ', '
                i += 1
    ...
    def genres_list_string(self):
        ...
        while i < len(genre_list):
            if len(genre_list) - i == 1:
                string += str(genre_list[i])
            elif len(genre_list) - i > 1:
                string += str(genre_list[i]) + ','
            i += 1
