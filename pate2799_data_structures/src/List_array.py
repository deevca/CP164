...
class List:
    ...
    def _linear_search(self, key):
        ...
        i = 0
        found = False
        while i < len(self._values) and found == False:
    ...
    def clean(self):
        ...
        while i < len(self._values):
            if self._values[i] in clean_list:
                self._values.pop(i)
            else:
                clean_list.append(self._values[i])
                i += 1
        return
    ...
    def combine(self, source1, source2):
        ...
        while len(source1) > 0:
            if len(source2) > 0:
                self._values.append(deepcopy(source1.pop(0)))
                self._values.append(deepcopy(source2.pop(0)))
            else:
                self._values.append(deepcopy(source1.pop(0)))
        while len(source2) > 0:
            self._values.append(deepcopy(source2.pop(0)))
    ...
    def intersection(self, source1, source2):
        ...
        i = 0
        while i < len(source1):
            if source1[i] in source2 and source1[i] not in self._values:
                self._values.append(deepcopy(source1[i]))
            i += 1
        return
