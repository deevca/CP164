...
def stack_test(source):
    ...
    a = s.is_empty()
    print("Stack should be empty (True): {}".format(a))

    s.push(source.pop())

    a = s.is_empty()
    print("Stack should be non-empty (False): {}".format(a))

    b = s.pop()
    print("Should return and remove top value: {}".format(b))
    ...
    b = s.peek()
    print("Should return top value: {}".format(b))
